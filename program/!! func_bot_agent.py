...
class BotAgent:
    ...
    def open_trades(self):
        ...
        print("---")
        print(f"{self.market_2}: Place second order...")                
        ...
        try:
            ...
            self.order_dict["pair_status"] = "ERROR"
            self.order_dict["comments"] = f"Market 1 {self.market_2}: , {e}"
            return self.order_dict
